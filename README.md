...
- **聚焦器官：** **胃 + 胰腺为基础** → 延伸至胆管、食道、十二指肠、贲门
- **发展策略：** 深耕胃胰双核心，验证成功后横向复制到其他上消化道器官
...
|------|------|----------|----------|--------|----------|
| **Phase 1** | 2026 Q2-Q4 | **胃 + 胰腺** | 技术验证 + 数据积累 | AI 准确率≥85%<br>500+ 标注病例 | 科研合作模式 |
| **Phase 2** | 2027 Q1-Q3 | **+ 胆管 + 食道** | 产品化 + 试点验证 | 10+ 基层医院试点<br>多中心临床试验 | 二类器械备案 |
| **Phase 3** | 2027 Q4+ | **+ 十二指肠 + 贲门** | 规模化 + 合规申报 | NMPA 三类证申报<br>50+ 医院商业化 | 三类医疗器械注册证 |
...
验证成功后，我们将**横向复制**到胆管、食道、十二指肠、贲门，最终实现：
- ✅ 上消化道六器官全覆盖
- ✅ 统一的 AI 多智能体诊断平台
- ✅ 标准化充盈超声造影检查流程
- ✅ 智慧城市医疗数字化资产服务生态
