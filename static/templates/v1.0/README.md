...
### 官网首页
- `index.html` - 官网首页（国际大厂风格，中文版）
- `index-en.html` - 官网首页（英文版）
...
1. Hero 区域 - 价值主张
2. 统计数字 - 核心数据
3. 关于阿尔麦德 - 公司简介 + 核心公式 + 工作流程图
4. 四大技术支柱 - 核心技术
5. 四大运用场景 - 应用场景
6. 合作伙伴 - 产学研医
7. 三阶段路线图 - 实施规划
8. AI 诊断演示 - 快速体验（交互式 Demo）
9. 联合实验室 - 平台入口
10. 联系我们 - 联系方式
...
| **部署** | Nginx + systemd |
| **API** | JSON body 调用，timestamp 使用 isoformat |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| V1.0 | 2026-04-26 | 基线版本（国际大厂风格 + 双语 + Demo 区 + 公开 API） |
